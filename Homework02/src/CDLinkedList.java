public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) throws Exception {
		if (s1 == null || !(s1 instanceof DListIterator) || f1 == null || !(f1 instanceof DListIterator) 
			...
			DListNode start1 = ((DListIterator) s1).currentNode;
			DListNode final1 = ((DListIterator) f1).currentNode;
			DListNode start2 = ((DListIterator) s2).currentNode;
			DListNode final2 = ((DListIterator) f2).currentNode;
			if (final1.nextNode != start2) {
				DListNode start1temp = start1.previousNode;
				DListNode start2temp = start2.previousNode;
				DListNode final1temp = final1.nextNode;
				DListNode final2temp = final2.nextNode;
				start1.previousNode = start2temp;
				start2.previousNode = start1temp;
				start1temp.nextNode = start2;
				start2temp.nextNode = start1;
				final1.nextNode = final2temp;
				final2.nextNode = final1temp;
				final1temp.previousNode = final2;
				final2temp.previousNode = final1;
			} else {
				DListNode start1temp = start1.previousNode;
				DListNode start2temp = start2.previousNode;
				DListNode final1temp = final1.nextNode;
				...
				start2.previousNode = start1temp;
				start1temp.nextNode = start2;
				final2.nextNode = start1;
				start1.previousNode = final2;
				final1.nextNode = final2temp;
				final2temp.previousNode = final1;
			}
...
//			if (final1.currentNode.nextNode != start2.currentNode) {
//				DListIterator marker1 = new DListIterator (start1.currentNode);
//				DListIterator marker2 = new DListIterator (start2.currentNode);
//				insert(start1.next(),marker2);
//				start1.currentNode = start1.currentNode.nextNode;
//				removeAt(marker1);
//				;
//			} else {
//				DListIterator marker1 = new DListIterator (start1.currentNode);
